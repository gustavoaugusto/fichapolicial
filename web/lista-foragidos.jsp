            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="controlador?logica=ListaContatosLogic&restricao=foragidos"> <span class="glyphicon glyphicon-th-list"></span> Lista Foragidos</a>
                        </li>
                    </ul>
                </div>
            </nav>  
